...
class pixel(object):
    ...
    def getNeighbors(self, g):
        ...
        j = self.x // 10 # the var i is responsible for denoting the current col value in the grid
        i = self.y // 10 # the var j is responsible for denoting thr current row value in the grid
        rows = 28
        cols = 28
